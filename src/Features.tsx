  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(ellipse 70% 60% at 80% 10%, rgba(79, 142, 247, 0.30) 0%, transparent 70%),
            radial-gradient(ellipse 70% 60% at 20% 90%, rgba(124, 92, 252, 0.30) 0%, transparent 70%)
          `,
        }}
      />
