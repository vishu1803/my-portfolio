  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(ellipse 60% 60% at 80% 20%, rgba(124, 92, 252, 0.15) 0%, transparent 70%),
            radial-gradient(ellipse 60% 60% at 20% 80%, rgba(79, 142, 247, 0.15) 0%, transparent 70%)
          `,
        }}
      />
